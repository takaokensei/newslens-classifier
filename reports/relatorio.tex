...
\begin{itemize}
    ...
    \item \textbf{Validação Robusta}: K-fold CV (5 folds) demonstrou consistência dos resultados (desvio padrão < 0.02)
    \item \textbf{Hiperparâmetros Otimizados}: Otimização bayesiana (Optuna) garantiu que modelos estão otimizados, não apenas com valores padrão
\end{itemize}
