...
\begin{center}
    ...
    {\color{white}\bfseries\textls[50]{
       \textcolor{accent}{ELE 606} – \textcolor{white}{\MakeUppercase{Tópicos Especiais em Inteligência Artificial}}
    }}
    ...
    \begin{center}
    {\Large\bfseries
    {\color{accent}NEWSLENS AI}}

    \vspace{0.4cm}
    
    {\Large\bfseries\color{white}
    ANÁLISE COMPARATIVA DE\\[0.2cm]
    REPRESENTAÇÕES}
    \end{center}
    ...
    % --- PROFESSOR ---
    {\color{white}\small\bfseries\textls[50]{\MakeUppercase{Professor Dr. JOSÉ ALFREDO F. COSTA}}}
